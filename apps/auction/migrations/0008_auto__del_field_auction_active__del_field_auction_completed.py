...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Auction.active'
        db.delete_column('auction_auction', 'active')

        # Deleting field 'Auction.completed'
        db.delete_column('auction_auction', 'completed')


    def backwards(self, orm):
        # Adding field 'Auction.active'
        db.add_column('auction_auction', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Auction.completed'
        db.add_column('auction_auction', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
