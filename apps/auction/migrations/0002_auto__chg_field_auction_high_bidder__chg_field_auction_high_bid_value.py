...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Auction.high_bidder'
        db.alter_column('auction_auction', 'high_bidder_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Auction.high_bid_value'
        db.alter_column('auction_auction', 'high_bid_value', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Auction.high_bidder'
        db.alter_column('auction_auction', 'high_bidder_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Auction.high_bid_value'
        db.alter_column('auction_auction', 'high_bid_value', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        'auction.auction': {
            ...
            'high_bid_value': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'high_bidder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
