...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bid.current_value'
        db.alter_column('auction_bid', 'current_value', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Bid.current_value'
        db.alter_column('auction_bid', 'current_value', self.gf('django.db.models.fields.IntegerField')(default=None))
