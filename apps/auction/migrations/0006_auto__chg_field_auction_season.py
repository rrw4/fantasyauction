...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Auction.season'
        db.alter_column('auction_auction', 'season_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['league.Season']))

    def backwards(self, orm):

        # Changing field 'Auction.season'
        db.alter_column('auction_auction', 'season_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['league.Season'], null=True))
