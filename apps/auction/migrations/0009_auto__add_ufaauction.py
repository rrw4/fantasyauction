...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UFAAuction'
        db.create_table('auction_ufaauction', (
            ('auction_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auction.Auction'], unique=True, primary_key=True)),
            ('original_owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('discount_percentage', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('discount_max', self.gf('django.db.models.fields.IntegerField')(default=5)),
        ))
        db.send_create_signal('auction', ['UFAAuction'])


    def backwards(self, orm):
        # Deleting model 'UFAAuction'
        db.delete_table('auction_ufaauction')
    ...
    models = {
        ...
        'auction.ufaauction': {
            'Meta': {'object_name': 'UFAAuction', '_ormbases': ['auction.Auction']},
            'auction_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auction.Auction']", 'unique': 'True', 'primary_key': 'True'}),
            'discount_max': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'discount_percentage': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'original_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'auth.group': {
